      ...
      <div>
        <div className="p-4 w-[700px] h-48 bg-[#EBD4CB] rounded-br-[50px] rounded-tl-[50px] flex ml-[550px] absolute top-[449px]">
          ...
          <div className="w-[250px] flex flex-col justify-center ml-4">
            ...
            <p>Recipient of the 2024 International Perfumer of Guild Award</p>
          </div>
          ...
          <div className="w-[250px] flex flex-col justify-center ml-4">
            ...
            <p>Featuring <q>Elixir of Enchantment</q>  our top selling fragrance for 3 consecutive years</p>
          </div>
        </div>
      </div>
    </div>
